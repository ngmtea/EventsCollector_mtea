...
from artifacts.abi.lending.geist.lending_pool_geist_abi import LENDING_POOL_GEIST_ABI
from artifacts.abi.lending.aave.lending_pool_aave_v1_abi import LENDING_POOL_AAVE_V1_ABI
